...
import type { Assembly, LineItem, Material } from '@/src/domain/types';
    ...
    <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
      ...
      <View style={styles.headerBtns}>
        <Pressable style={styles.addItemBtn} onPress={() => setAssemblyPickerOpen(true)}>
          <Text style={styles.addItemText} numberOfLines={1}>+ Job</Text>
        </Pressable>
        <Pressable style={styles.addItemBtn} onPress={() => setLabourOpen(true)}>
          <Text style={styles.addItemText} numberOfLines={1}>+ Labour</Text>
        </Pressable>
        <Pressable style={styles.addItemBtn} onPress={() => setPickerOpen(true)}>
          <Text style={styles.addItemText} numberOfLines={1}>+ Material</Text>
        </Pressable>
        <Pressable style={styles.addItemBtn} onPress={() => setShoppingOpen(true)}>
          <Text style={styles.addItemText} numberOfLines={1}>+ Shop</Text>
        </Pressable>
      </View>
